                ...
                <div class="table-responsive">
                    <table class="table table-dark mx-auto m-3">
                        ...
                        <tr>
                            ...
                            <td class="actions d-flex justify-evenly">
                                ...
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Telefones', 'action' => 'edit', $telefones->id], ['class'=>'bg-success link-dark rounded p-2 text-decoration-none']) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Telefones', 'action' => 'delete', $telefones->id], ['confirm' => __('Are you sure you want to delete # {0}?', $telefones->id), 'class'=>'bg-success link-dark rounded p-2 text-decoration-none']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
