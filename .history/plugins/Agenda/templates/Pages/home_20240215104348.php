...
<div class="paginator">
        <ul class="pagination">
          ...
          {
            <p>$this->Paginator->counter(__('Página {{page}} de {{pages}}, Listando {{current}} item de {{count}} no total'));
          }else{
            <p>$this->Paginator->counter(__('Página {{page}} de {{pages}}, Listando {{current}} item(s) de {{count}} no total'));
          }
