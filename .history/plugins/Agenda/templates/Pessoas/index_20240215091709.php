...
<div class="d-flex justify-content-lg-start gap-lg-3">
    <?= $this->Html->link(__('Cadastrar'), ['action' => 'index'], ['class'=>'bg-info link-dark rounded p-2 text-decoration-none']) ?>
    <?= $this->Html->link(__('Adicionar'), ['action' => 'add'], ['class'=>'bg-info link-dark rounded p-2 text-decoration-none']) ?>
</div>
