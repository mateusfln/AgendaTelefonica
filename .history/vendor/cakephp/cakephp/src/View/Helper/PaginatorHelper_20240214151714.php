...
class PaginatorHelper extends Helper
{
    ...
    protected array $_defaultConfig = [
        ...
        'templates' => [
            ...
            'current' => '<li class="page-item"><a class="page-link">{{text}}</a></li>',
            'ellipsis' => '<li class="ellipsis">&hellip;</li>',
            'sort' => '<a href="{{url}}" class="text-decoration-none text-light">{{text}}</a>',
            'sortAsc' => '<a class="asc text-decoration-none text-success" href="{{url}}">{{text}}</a>',
            'sortDesc' => '<a class="desc text-decoration-none text-danger" href="{{url}}">{{text}}</a>',
