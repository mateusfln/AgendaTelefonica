                    ...
                    <table class="table table-light mx-auto m-3">
                        ...
                        <tr>
                            ...
                            <td class="actions d-flex justify-content-evenly">
                                ...
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Telefones', 'action' => 'edit', $telefone->id], ['class'=>'bg-info link-dark rounded p-2 text-decoration-none']) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Telefones', 'action' => 'delete', $telefone->id], ['confirm' => __('Are you sure you want to delete # {0}?', $telefones->id), 'class'=>'bg-danger link-dark rounded p-2 text-decoration-none']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
