 ...
 */
 GLOBAL NUMERO_DE_TELEFONE = '+'.$telefone->ddi.' ('.$telefone->ddd.') '.''.$telefone->numero;
...
$this->Breadcrumbs->add(
  $numeroDeTelefone,
  ['controller' => 'telefones', 'action' => 'view', $telefone->pessoa_id]
);
...
<div class="row">
    <div class="column column-80">
        <div class="telefones view content">
            <h3>
               <?php 
               echo __('Telefone '. $numeroDeTelefone)
               ?>
             </h3>
...
<?= $this->Html->link(__('Voltar'), ['controller'=>'pessoas','action' => 'index'], ['class' => 'side-nav-item btn btn-default bg-info my-5']) ?>
