            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="actions d-flex justify-content-evenly">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $teledf->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pessoa->id), 'class'=>'bg-danger link-dark rounded p-2 text-decoration-none']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
