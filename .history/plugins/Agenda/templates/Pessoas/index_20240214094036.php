...
<div class="pessoas index content">
    ...
    <div class="table-responsive">
        <table class="table table-dark mx-auto m-3">
            <thead>
                <tr>
                    <th class='text-decoration-none'><?= $this->Paginator->sort('id') ?></th>
                    <th class='text-decoration-none'><?= $this->Paginator->sort('nome_completo') ?></th>
                    <th class='text-decoration-none'><?= $this->Paginator->sort('cpf') ?></th>
